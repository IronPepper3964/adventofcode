...
for rotation in puzzle_input:
    ...
    print(f"rotation: {rotation} | rotation_dir:{rotation_dir} |  rotation_count:{rotation_count} |  rotation_remainder_amount:{rotation_remainder_amount}")
    pass
    ...
    print(f"Current Position: {current_position} | rotation: {rotation_remainder_amount} | zero_count: {zero_count} | Input: {rotation[:-1]}")
